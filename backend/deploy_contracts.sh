...
# Function to extract deployed address from forge create output
extract_address() {
    grep "Deployed to:" | awk '{print $3}'
}

# Deploy ITCToken20
echo "📄 1. Deploying ITCToken20..."
