...
export const CONTRACT_ABIS = {
  ITCToken20: [
    ...
    'function selfBurn(uint256)',
    'function getBurnRecord(uint256) view returns (address, uint256, uint256, uint256)',
    'function getTotalBurnTransactions() view returns (uint256)',
    'function getTotalTokensBurned() view returns (uint256)',
    'function getAllBurnIds() view returns (uint256[])',
    'function getBurnRecordsRange(uint256, uint256) view returns (address[], uint256[], uint256[], uint256[])',
    'function getBurnStatistics() view returns (uint256, uint256, uint256)',
    ...
    'event TokensBurned(address indexed, uint256, uint256, uint256, uint256)',
  ...
  Invoice: [
    ...
    'function createInvoiceForPurchase(uint256 companyId, uint256 number, address clientAddress, tuple(uint256 productId, uint256 quantity, uint256 unitPrice, uint256 totalPrice)[] items, bool useTokens) returns (uint256)',
